...
class FormatExcelFreedom {
    ...
    private void setUnderline() {
        ...
        this.underline.put("single_accounting", UnderlineStyle.SINGLE_ACCOUNTING);
    ...
    private void setFormat() {
        NumberFormat oneDigit = new NumberFormat("#,##0.0");
        ...
        this.format.put("number-float-one-left", setFormatCellNumber(Alignment.LEFT, oneDigit));
        this.format.put("number-float-one-center", setFormatCellNumber(Alignment.CENTRE, oneDigit));
        this.format.put("number-float-one-right", setFormatCellNumber(Alignment.RIGHT, oneDigit));
        this.format.put("number-float-one-left-top", setFormatCellNumber(Alignment.LEFT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-center-top", setFormatCellNumber(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-right-top", setFormatCellNumber(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-left-middle", setFormatCellNumber(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-center-middle", setFormatCellNumber(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-right-middle", setFormatCellNumber(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit));

        this.format.put("number-float-two-left", setFormatCellNumber(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-center", setFormatCellNumber(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-right", setFormatCellNumber(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-left-top", setFormatCellNumber(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-center-top", setFormatCellNumber(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-right-top", setFormatCellNumber(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-left-middle", setFormatCellNumber(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-center-middle", setFormatCellNumber(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-right-middle", setFormatCellNumber(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        ...
        this.format.put("number-float-one-border-left", setFormatCellNumberBorder(Alignment.LEFT, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-center", setFormatCellNumberBorder(Alignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-right", setFormatCellNumberBorder(Alignment.RIGHT, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-left-top", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-center-top", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-right-top", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-left-middle", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-center-middle", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-right-middle", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));

        this.format.put("number-float-one-border-dashed-left", setFormatCellNumberBorder(Alignment.LEFT, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-center", setFormatCellNumberBorder(Alignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-right", setFormatCellNumberBorder(Alignment.RIGHT, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-left-top", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-center-top", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-right-top", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-left-middle", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-center-middle", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-right-middle", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));

        this.format.put("number-float-two-border-left", setFormatCellNumberBorder(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-center", setFormatCellNumberBorder(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-right", setFormatCellNumberBorder(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-left-top", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-center-top", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-right-top", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-left-middle", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-center-middle", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-right-middle", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));

        this.format.put("number-float-two-border-dashed-left", setFormatCellNumberBorder(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-center", setFormatCellNumberBorder(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-right", setFormatCellNumberBorder(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-left-top", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-center-top", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-right-top", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-left-middle", setFormatCellNumberBorder(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-center-middle", setFormatCellNumberBorder(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-right-middle", setFormatCellNumberBorder(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));

        this.format.put("number-float-one-border-tb-left", setFormatCellNumberBorderTopBottom(Alignment.LEFT, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-center", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-right", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-left-top", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-center-top", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-right-top", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-left-middle", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-center-middle", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));
        this.format.put("number-float-one-border-tb-right-middle", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.THIN));

        this.format.put("number-float-one-border-dashed-tb-left", setFormatCellNumberBorderTopBottom(Alignment.LEFT, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-center", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-right", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-left-top", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-center-top", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-right-top", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-left-middle", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-center-middle", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));
        this.format.put("number-float-one-border-dashed-tb-right-middle", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit, BorderLineStyle.DASHED));

        this.format.put("number-float-two-border-tb-left", setFormatCellNumberBorderTopBottom(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-center", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-right", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-left-top", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-center-top", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-right-top", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-left-middle", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-center-middle", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));
        this.format.put("number-float-two-border-tb-right-middle", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.THIN));

        this.format.put("number-float-two-border-dashed-tb-left", setFormatCellNumberBorderTopBottom(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-center", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-right", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-left-top", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-center-top", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-right-top", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-left-middle", setFormatCellNumberBorderTopBottom(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-center-middle", setFormatCellNumberBorderTopBottom(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));
        this.format.put("number-float-two-border-dashed-tb-right-middle", setFormatCellNumberBorderTopBottom(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT, BorderLineStyle.DASHED));

        this.format.put("number-float-one-border-tb-double-left", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, oneDigit));
        this.format.put("number-float-one-border-tb-double-center", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-double-right", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, oneDigit));
        this.format.put("number-float-one-border-tb-double-left-top", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-double-center-top", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-double-right-top", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-double-left-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-double-center-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-double-right-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit));

        this.format.put("number-float-two-border-tb-double-left", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-center", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-right", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-left-top", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-center-top", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-right-top", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-left-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-center-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-double-right-middle", setFormatCellNumberBorderTopBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));

        this.format.put("number-float-one-border-tb-single-double-center", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-right", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-left-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.LEFT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-center-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-right-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-left-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-center-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-tb-single-double-right-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit));

        this.format.put("number-float-two-border-tb-single-double-left", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-center", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-right", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-left-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-center-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-right-top", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-left-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-center-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-tb-single-double-right-middle", setFormatCellNumberBorderTopBottomSingleDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));

        this.format.put("number-float-one-border-b-double-center", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-b-double-right", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, oneDigit));
        this.format.put("number-float-one-border-b-double-left-top", setFormatCellNumberBorderBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-b-double-center-top", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-b-double-right-top", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-b-double-left-middle", setFormatCellNumberBorderBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-b-double-center-middle", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-b-double-right-middle", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit));

        this.format.put("number-float-two-border-b-double-left", setFormatCellNumberBorderBottomDouble(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-center", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-right", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-left-top", setFormatCellNumberBorderBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-center-top", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-right-top", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-left-middle", setFormatCellNumberBorderBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-center-middle", setFormatCellNumberBorderBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-b-double-right-middle", setFormatCellNumberBorderBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));

        this.format.put("number-float-one-border-all-b-double-left", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, oneDigit));
        this.format.put("number-float-one-border-all-b-double-center", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-all-b-double-right", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, oneDigit));
        this.format.put("number-float-one-border-all-b-double-left-top", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-all-b-double-center-top", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-all-b-double-right-top", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, oneDigit));
        this.format.put("number-float-one-border-all-b-double-left-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-all-b-double-center-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, oneDigit));
        this.format.put("number-float-one-border-all-b-double-right-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, oneDigit));

        this.format.put("number-float-two-border-all-b-double-left", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-center", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-right", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-left-top", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-center-top", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-right-top", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, VerticalAlignment.TOP, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-left-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.LEFT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-center-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.CENTRE, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
        this.format.put("number-float-two-border-all-b-double-right-middle", setFormatCellNumberBorderAllBottomDouble(Alignment.RIGHT, VerticalAlignment.CENTRE, NumberFormats.THOUSANDS_FLOAT));
